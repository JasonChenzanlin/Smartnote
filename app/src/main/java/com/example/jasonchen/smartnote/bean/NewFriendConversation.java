...
import com.example.jasonchen.smartnote.SmartNote;
...
public class NewFriendConversation extends Conversation{
    ...
    public int getUnReadCount() {
        return NewFriendManager.getInstance(SmartNote.INSTANCE()).getNewInvitationCount();
    }

    @Override
    public void readAllMessages() {
        //批量更新未读未认证的消息为已读状态
        NewFriendManager.getInstance(SmartNote.INSTANCE()).updateBatchStatus();
    }
